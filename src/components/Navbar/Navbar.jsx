...
import logo from "../../assets/sabari.svg";
          ...
          >
            <defs id="SvgjsDefs1540">
              <linearGradient id="SvgjsLinearGradient1545">
                <stop id="SvgjsStop1546" stop-color="#8f5e25" offset="0"></stop>
                <stop
                  id="SvgjsStop1547"
                  stop-color="#fbf4a1"
                  offset="0.5"
                ></stop>
                <stop id="SvgjsStop1548" stop-color="#8f5e25" offset="1"></stop>
              </linearGradient>
              <linearGradient id="SvgjsLinearGradient1549">
                <stop id="SvgjsStop1550" stop-color="#8f5e25" offset="0"></stop>
                <stop
                  id="SvgjsStop1551"
                  stop-color="#fbf4a1"
                  offset="0.5"
                ></stop>
                <stop id="SvgjsStop1552" stop-color="#8f5e25" offset="1"></stop>
              </linearGradient>
            </defs>
            <g
              id="SvgjsG1541"
